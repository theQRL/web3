...
var errors = require('@theqrl/web3-core-helpers').errors;
var formatters = require('@theqrl/web3-core-helpers').formatters;
var utils = require('@theqrl/web3-utils');
var promiEvent = require('@theqrl/web3-core-promievent');
                            ...
                            if (receipt.status === false || receipt.status === '0x0') {
                                try {
                                    ...
                                    if ( method.handleRevert &&
                                        (method.call === 'zond_sendTransaction' || method.call === 'zond_sendRawTransaction'))
                                    {
                                        var txReplayOptions = payload.params[0];

                                        // If send was raw, fetch the transaction and reconstitute the
                                        // original params so they can be replayed with `eth_call`
                                        if (method.call === 'zond_sendRawTransaction'){
...
Method.prototype.buildCall = function () {
    var method = this,
        isSendTx = (method.call === 'zond_sendTransaction' || method.call === 'zond_sendRawTransaction'), // || method.call === 'personal_sendTransaction'
        isCall = (method.call === 'zond_call');
    ...
    var send = function () {
        ...
        if(method.call === 'zond_getTransactionReceipt'){
        ...
        var sendRequest = function (payload, method) {
            ...
            if (method && method.accounts && method.accounts.wallet && method.accounts.wallet.length) {
                ...
                if (payload.method === 'zond_sendTransaction') {
                    ...
                    // ETH_SIGN
                } else if (payload.method === 'zond_sign') {

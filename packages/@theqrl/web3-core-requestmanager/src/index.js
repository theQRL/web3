...
RequestManager.providers = {
    WebsocketProvider: require('@theqrl/web3-providers-ws'),
    HttpProvider: require('@theqrl/web3-providers-http'),
    IpcProvider: require('@theqrl/web3-providers-ipc')
};
    ...
    if (this.provider && this.provider.on) {
        if (typeof provider.request === 'function') { // EIP-1193 provider
            this.provider.on('message', function (payload) {
                if (payload && payload.type === 'zond_subscription' && payload.data) {

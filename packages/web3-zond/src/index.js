...
var blockCall = function (args) {
    return (typeof args[0] === 'string' && args[0].indexOf('0x') === 0) ? "zond_getBlockByHash" : "zond_getBlockByNumber";
};
...
var uncleCall = function (args) {
    return (typeof args[0] === 'string' && args[0].indexOf('0x') === 0) ? 'zond_getUncleByBlockHashAndIndex' : 'zond_getUncleByBlockNumberAndIndex';
};
...
var uncleCountCall = function (args) {
    return (typeof args[0] === 'string' && args[0].indexOf('0x') === 0) ? 'zond_getUncleCountByBlockHash' : 'zond_getUncleCountByBlockNumber';
};
